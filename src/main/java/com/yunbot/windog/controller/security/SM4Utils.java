...
public class SM4Utils {
    ...
    public static void main(String[] args) {
        try {
            String json = "Lynl29519205";
            System.out.println("加密前源数据————" + json.length());
            System.out.println(json);
            // 生成32位16进制密钥
            String key = SM4Utils.generateKey();
            //key:  87290669DBC08D39497589B455E0FCB4
//            System.out.println(key + "-----生成key");
            ...
            System.out.println("解密后数据---" + json.length());
            System.out.println(json);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    //加密方法
    public static String sm4Encode(String sin) {
        String key = "87290669DBC08D39497589B455E0FCB4";
        return SM4Utils.encryptEcb(key, sin);
    }

    //解密方法
    public static String sm4Decode(String sin) {
        String key = "87290669DBC08D39497589B455E0FCB4";
        return SM4Utils.decryptEcb(key, sin);
    }
