package com.yunbot.windog.common.log;
...
import com.yunbot.windog.service.SysOperLogService;
import com.yunbot.windog.shiro.util.ShiroUtils;
import com.yunbot.windog.util.ServletUtils;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.yunbot.windog.common.log.Log)")
