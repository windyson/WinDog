...
import com.yunbot.windog.mapper.auto.SysNoticeMapper;
import com.yunbot.windog.mapper.auto.SysNoticeUserMapper;
import com.yunbot.windog.model.auto.SysNotice;
import com.yunbot.windog.model.auto.SysNoticeExample;
import com.yunbot.windog.model.auto.SysNoticeUser;
import com.yunbot.windog.model.auto.SysNoticeUserExample;
import com.yunbot.windog.model.auto.SysNoticeUserExample.Criteria;
	 ...
	 */
	 public PageInfo<SysNotice> list(TsysUser tsysUser,Tablepar tablepar,String name){
			...
			if(noticeUsers!=null&&noticeUsers.size()>0) {
		        ...
		        com.yunbot.windog.model.auto.SysNoticeExample.Criteria criteria1= testExample.createCriteria();
		        if(name!=null&&!"".equals(name)){
