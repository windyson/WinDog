package com.yunbot.windog.model.custom.autocode;
...
/*            表关系配置
    ...
    /**
     * 生成代码的父包 如父包是com.yunbot.windog  controller将在com.yunbot.windog.controller下 bean 将在com.yunbot.windog.bean下 ,service,dao同理
     */
