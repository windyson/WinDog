...
//		设置路径映射，注意这里要用LinkedHashMap 保证有序
        ...
        //log interface by william
        filterChainDefinitionMap.put("/EventCollector/**", "anon");
        filterChainDefinitionMap.put("/LogCollector/**", "anon");
        filterChainDefinitionMap.put("/AlertCollector/**", "anon");
        filterChainDefinitionMap.put("/TestReportController/editFunctions/**", "anon");
        //对所有页面进行认证
